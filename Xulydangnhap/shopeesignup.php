  ...
  <main class="login-content">
    <div class="container container-login">
      ...
      <div class="form-login">
        <form class="form-login" action="xulydangky.php" method="post">
          <h2>Đăng ký</h2>
          ...
          session_destroy();
            ?>
            <!-- <h3 href="http://"><a class="link-signup" href="http://">Đăng Ký</a> nếu bạn chưa là thành viên của chúng tôi</h3> -->
        </form>
      </div>
    </div>
  </main>
